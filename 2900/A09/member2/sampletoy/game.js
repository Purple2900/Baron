...
Stanley Cliche
Team Pawn
Mod 1: Changed grid size from 7 by 7 to 14 by 7
Mod 2: Changed grid color to A458FF
Mod 3: Changed status text from 'Touch any bead' to 'Click any bead'
Mod 4: Changed audio load to fx_ding
Mod 5: Under PS.touch I changed the border color to cyan
Mod 6: Under PS.touch I added a glyph 'X' with a magenta glyph color
Mod 7: Under PS.touch I changed the audio play to fx_ding
 */
/*
...
PS.touch = function( x, y, data, options ) {
	...
	PS.borderColor(x, y, PS.COLOR_CYAN); //set border color
	PS.glyph(x, y, "X"); //set a glyph for each clicked bead
	PS.glyphColor(x, y, PS.COLOR_MAGENTA) //set a color for the glyph
